...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilities.item.CAbilityItemTrashbringer;
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilities.types.CAbilityType;
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilities.types.CAbilityTypeLevelData;

public class CAbilityTypeItemTrashbringer extends CAbilityType<CAbilityTypeItemAttackBonusLevelData> {

	public CAbilityTypeItemTrashbringer(final War3ID alias, final War3ID code,
	...
	public CAbility createAbility(final int handleId) {
		...
		return new CAbilityItemTrashbringer(handleId, getCode(), getAlias(), levelData.getDamageBonus());
	}
