...
public interface AbilityBuilderActiveAbility
		extends AbilityBuilderAbility, CAutocastAbility, GenericSingleIconActiveAbility {
	@Override
	...
	public void checkCanTarget(final CSimulation game, final CUnit unit, int playerIndex, final int orderId,
			boolean autoOrder, final CWidget target, final AbilityTargetCheckReceiver<CWidget> receiver);

	@Override
	public void checkCanTarget(final CSimulation game, final CUnit unit, int playerIndex, final int orderId,
			boolean autoOrder, final AbilityPointTarget target,
			final AbilityTargetCheckReceiver<AbilityPointTarget> receiver);

	@Override
	public void checkCanTargetNoTarget(final CSimulation game, final CUnit unit, int playerIndex, final int orderId,
			boolean autoOrder, final AbilityTargetCheckReceiver<Void> receiver);

	public void internalBegin(CSimulation game, CUnit theCaster, int playerIndex, int orderId, boolean b,
			AbilityTarget theTarget);
