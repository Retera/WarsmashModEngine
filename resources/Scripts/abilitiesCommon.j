...
library AbilitiesCommonLegacy requires TargetTypesAPI, AnimationTokensAPI
	...
	globals
        ...
        constant abconftype AB_CONF_TYPE_NORMAL_FLEXTARGET                 = ConvertABConfType(2)
        constant abconftype AB_CONF_TYPE_NORMAL_UNITTARGET                 = ConvertABConfType(3)
        constant abconftype AB_CONF_TYPE_NORMAL_POINTTARGET                = ConvertABConfType(4)
        constant abconftype AB_CONF_TYPE_NORMAL_NOTARGET                   = ConvertABConfType(5)
        constant abconftype AB_CONF_TYPE_PASSIVE                           = ConvertABConfType(6)
        constant abconftype AB_CONF_TYPE_TEMPLATE                          = ConvertABConfType(7)
        constant abconftype AB_CONF_TYPE_INHERIT                           = ConvertABConfType(8)
        constant abconftype AB_CONF_TYPE_HIDDEN                            = ConvertABConfType(9)
