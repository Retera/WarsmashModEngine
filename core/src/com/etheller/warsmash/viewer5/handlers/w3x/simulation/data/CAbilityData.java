...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilities.types.definitions.impl.CAbilityTypeDefinitionBag;
...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilities.types.definitions.impl.CAbilityTypeDefinitionItemTrashbringer;
...
//		this.codeToAbilityTypeDefinition.put(War3ID.fromString("AHca"), new CAbilityTypeDefinitionColdArrows());
		...
		this.codeToAbilityTypeDefinition.put(War3ID.fromString("Abag"), new CAbilityTypeDefinitionBag());
		this.codeToAbilityTypeDefinition.put(War3ID.fromString("Abg2"), new CAbilityTypeDefinitionBag());
		...
		this.codeToAbilityTypeDefinition.put(War3ID.fromString("Atra"), new CAbilityTypeDefinitionItemTrashbringer());
		...
		this.codeToAbilityTypeDefinition.put(War3ID.fromString("Apwn"),
				new CAbilityTypeDefinitionSpellBase((handleId, alias) -> new CAbilityPlayerPawn(handleId, alias)));
