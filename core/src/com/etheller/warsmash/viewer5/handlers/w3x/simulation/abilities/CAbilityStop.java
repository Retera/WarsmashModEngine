...
public class CAbilityStop implements CAbility {
	public static final int ORDER_ID = 860003; // fake, later will use WC3 one probably
	public static CAbilityStop INSTANCE = new CAbilityStop();
