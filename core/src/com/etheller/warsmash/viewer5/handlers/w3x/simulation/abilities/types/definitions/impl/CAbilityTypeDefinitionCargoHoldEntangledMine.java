...
//		final int lumberCost = abilityEditorData.getFieldAsInteger(LUMBER_COST, level);
		...
		return new CAbilityTypeCargoHoldLevelData(targetsAllowedAtLevel, cargoCapacity, duration, castRange);
	}

	@Override
	protected CAbilityType<?> innerCreateAbilityType(final War3ID alias, final MutableGameObject abilityEditorData,
			final List<CAbilityTypeCargoHoldLevelData> levelData) {
		return new CAbilityTypeCargoHoldEntangledMine(alias, abilityEditorData.getCode(), levelData);
	}
