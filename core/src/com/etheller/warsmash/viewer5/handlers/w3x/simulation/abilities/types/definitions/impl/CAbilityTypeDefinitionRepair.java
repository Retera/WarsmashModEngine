...
public class CAbilityTypeDefinitionRepair extends AbstractCAbilityTypeDefinition<CAbilityTypeHumanRepairLevelData>
	...
	@Override
	protected CAbilityTypeHumanRepairLevelData createLevelData(final MutableGameObject abilityEditorData,
			final int level) {
		...
		return new CAbilityTypeHumanRepairLevelData(targetsAllowedAtLevel, navalRangeBonus, costRatio, timeRatio,
				castRange);
	}
	...
	protected CAbilityType<?> innerCreateAbilityType(final War3ID alias, final MutableGameObject abilityEditorData,
		...
		return new CAbilityTypeRepair(alias, abilityEditorData.getCode(), levelData);
	}
