...
public class CAbilityBlightedGoldMine extends CAbilityOverlayedMine {
	...
	public CAbilityBlightedGoldMine(final int handleId, final War3ID code, final War3ID alias,
			final int goldPerInterval, final float intervalDuration, final int maxNumberOfMiners,
			final float radiusOfMiningRing) {
