...
public class CAbilityAbilityBuilderSingleIconNoSmartActive extends AbstractGenericSingleIconNoSmartActiveAbility {

	List<CAbilityTypeAbilityBuilderLevelData> levelData;
	private AbilityBuilderParser parser;
	private Map<String, Object> localStore;

	public CAbilityAbilityBuilderSingleIconNoSmartActive(int handleId, War3ID alias,
