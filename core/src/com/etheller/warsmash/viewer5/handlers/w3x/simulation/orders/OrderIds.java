 ...
 */
/**
 * The list was updated with WaterKnights list of order ids from the following
 * link: https://www.hiveworkshop.com/threads/list-of-order-ids.350361/
 * https://docs.google.com/spreadsheets/d/10hNbIwFr4-y90pS5R9olWNT6lmD8-iZcBOafck58Xm4/edit#gid=0
 *
 * WaterKnight does not provide a license on the list, but the list was adapted
 * to Java as part of including it
 *
 */
public class OrderIds {
	...
	/**
	 * "targeting a friendly or neutral unit, it's like smart, moving to the target,
	 * following, highlighting patrol, triggering effects like moon well heal
	 * targeting an enemy unit, it attacks the target targeting a tree, it harvests
	 * it or moves to it (latter unlike 851971), eat tree or war club does not work
	 * targeting a point, the unit moves to it while attacking enemies on the way
	 * targeting an item on the ground, it will be issued even without inventory but
	 * does nothing"
	 **/
	public static final int _recycleguardposition = 851974; // ? () -- is issued when guard position is recycled or when
															// the unit is neutral hostile and it gets an expiration
															// timer (non-exhaustive)
	public static final int _instant3 = 851975; // instant3 () --
	public static final int _deprecatedcancel = 851977; // some deprecated cancel? () -- can be issued to an altar
														// targeting a hero reviving, but does not have an effect
	public static final int _cancelprogress = 851978; // cancel structure/upgrade of structure () -- can also be issued
														// when the unit has other abilities that cause progress (unit
														// training, research, sacrificing, reviving) but does not have
														// an effect there
	public static final int _instant2 = 851987; // instant2 () -- is issued when the unit returned to its guard
												// position, idle?
	...
	public static final int _allmodblightplacementsacrificialskullpassivesdetectionalsoflyersubmerge = 852290; // all
																												// mod,
																												// blight
																												// placement
																												// (sacrificial
																												...
																												// ANsu)
																												// --
	public static final int _awakenunit1tavern = 852462; // awaken unit 1 (tavern) (Aawa) -- must be issued targeting
															// the hero to awaken
	public static final int _awakenunit2tavern = 852463; // awaken unit 2 (tavern) (Aawa) -- must be issued targeting
															// the hero to awaken
	public static final int _awakenunit3tavern = 852464; // awaken unit 3 (tavern) (Aawa) -- must be issued targeting
															// the hero to awaken
	public static final int _awakenunit4tavern = 852465; // awaken unit 4 (tavern) (Aawa) -- must be issued targeting
															// the hero to awaken
	public static final int _cannibalizetarget = 852535; // cannibalize (Acan) -- unit target, can even be cast if the
															// unit has full life (Acan)
	...
	public static final int _attacktargetpriority = 852677; // attack target priority (Aatp) -- Aatp: used for both
															// activating and deactivating the ability
	...
	public static final int _unknown852460 = 852460; // ?? (can be issued on targets) () -- can be issued on targets
														// (unit/item/destructable), target must not be the unit itself,
														// target unit must be visible, ordered unit must generally be
														// able to move
